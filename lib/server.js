...
Server.prototype.manageSchema = function (noExit) {
    var self = this;
    return this.startMaintenanceMode()
        .then(function () {
            if (self.appServer.databaseIsEmpty) {
        ...
        .catch(function (error) {
            serverLogger.error(error, 'Failed to manage schema');
            throw error;
        })
        .always(function () {
            return self.appServer.shutdown(noExit);
...
Server.prototype.startMaintenanceMode = function () {
    ...
    return self.start()
        .then(function (startMaintenanceMode) {
